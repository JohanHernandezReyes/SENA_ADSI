...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int ejercicio;
        double num1, num2, num3, num4, num5, resultado;
        ...
        else if(ejercicio==4)
        {
            ...
            for (int i=1; i<=10;i++)
            {
                ...
                if(i<10){lista+="Animal: "+animal+" - Dueño: "+dueño+"\n"+(i+1)+". ";}
        ...
        {    
            ...
            resultado = num1 - 10;
            JOptionPane.showMessageDialog(null,num1+" - 10 "+" = "+resultado, "RESULTADO",1);
        }
